...
<form action="index.php" method="post" class="uk-form">
        ...
        <div class="uk-margin">
            ...
            <textarea name="data" value="<?= isset($_REQUEST['data']) ? htmlspecialchars($_REQUEST['data']) : 'input text data'; ?>" class="uk-input" type="text" placeholder="Input" aria-label="Input"></textarea>
        </div>
